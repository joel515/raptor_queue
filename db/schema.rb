...
ActiveRecord::Schema.define(version: 20160309164617) do
  ...
  add_index "documents", ["job_id", "created_at"], name: "index_documents_on_job_id_and_created_at"
